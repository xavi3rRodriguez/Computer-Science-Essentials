...
def student_name():
    pass
def search_list_for_student(name_search):
    for counter in List_of_homeroom_students:
        if name_search == counter.name:
            print("this student is on the list")
            return
    print("not on the list") 
def get_student_address(name_search):
    for counter in List_of_homeroom_students:
        if counter.name == name_search:
            print(counter.address)
def get_student_basic_info(name_search):
    for counter in List_of_homeroom_students:
        if counter.address == name_search:
            print(counter.grade)
...
def list_homeroom_students():
    for counter in List_of_homeroom_students:
        ...
        print("ID:",counter.ID)
        print("address:",get_student_address(name_search))
        print("age:",counter.age)
        print("locker number:",counter.LockerNum)
...
while True:
    ...
    try:
        ...
        if choice == 1:
            ...
            print("what student would you like to search")
            name_search = input(">>")
            #search_list_for_student()
            search_list_for_student(name_search)
        elif choice == 8:
            #exit
            break
        else:
